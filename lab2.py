...
#     # ('FGFR14' in lista_gene1)
#     if (element == 'FGFR4' or element == 'FGERA4'):
#         print ("Zawiera 'FGFR4' oraz 'FGERA4'")

# for element in lista_gene1:
#    if element.rfind('FGFR4') or element.rfind('FGERA4'):
#     print("Zawiera 'FGFR4' oraz 'FGERA4'")
#     break
...
tekst_ze_strony = ("Ale ku mojej uldze zabrakło jej najważniejszej umiejętności dziennikarza – zdolności do oddzielania interesujących informacji od tych zwyczajnie nudnych. "
                   "Choć prawidłowo podkreśliła, że stopa bezrobocia się nie zmieniła, Emma nie zauważyła, że liczba osób szukających zatrudnienia wzrosła po raz pierwszy od prawie roku. "
                   "Prawdą jest, że większość ludzi pracujących ze sztuczną inteligencją przyznaje, że nieprędko zastąpi ona człowieka. "
                   "Po prostu nie jest jeszcze wystarczająco inteligentna. To co zaczynamy jednak obserwować, jest dosyć subtelne, ale nie mniej ważne. "
                   "Granice pomiędzy pracą człowieka i pracą maszyny zaczynają się zacierać. Dla niektórych pracowników to mogłoby być dobrodziejstwo. "
                   "Wyobrażam sobie sytuację, w której taka maszyna jak Emma mogłaby tworzyć podstawowe raporty na bazie powtarzalnych danych i wysyłać je do redaktora, który by je upiększał i uatrakcyjniał. "
                   "Associated Press już teraz korzysta z programu zwanego Automated Insights, by pisać proste teksty o wynikach korporacji."
                   "W takich przypadkach ludzie mają przewagę – maszyny nie zastępują ich, a jedynie przejmują nudne elementy ich pracy, dzięki czemu więcej czasu mogą oni poświęcić na kreatywne lub ważne sprawy.")
# print (tekst_ze_strony.count('Emma'))
# print (tekst_ze_strony.upper())
# print(tekst_ze_strony.split(' '))
# print(tekst_ze_strony.count('.'))
...
#TODO
# procenty_z_zaliczenia = 0,95
# match procenty_z_zaliczenia:
#     case 1 <= procenty_z_zaliczenia<= 0.91: #91%-100%
#         print("5.0")
#     case 90<=80: #91%-100%
#         print("4.5")
